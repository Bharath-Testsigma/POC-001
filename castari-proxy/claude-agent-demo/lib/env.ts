...
const envSchema = z.object({
  ...
  PORTKEY_VK_ANTHROPIC: z.string().min(1).optional(),
  PORTKEY_VK_OPENAI: z.string().min(1).optional(),
  PORTKEY_VK_GOOGLE: z.string().min(1).optional(),
...
export const env: Env = envSchema.parse({
  ...
  PORTKEY_VK_ANTHROPIC: process.env.PORTKEY_VK_ANTHROPIC,
  PORTKEY_VK_OPENAI: process.env.PORTKEY_VK_OPENAI,
  PORTKEY_VK_GOOGLE: process.env.PORTKEY_VK_GOOGLE,
